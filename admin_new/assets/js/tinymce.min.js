...
! function() {
    ...
    const Ao = e => t => !!t && t.nodeType === e,
        ...
        $r = Do(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]),
        Vr = Do(["table"]),
        qr = Or,
        Wr = e => !qr(e) && (jr(e) ? !Hr(e.parentNode) : $r(e) || zr(e) || Vr(e) || Kr(e)),
    ...
    const os = (e, t = !0) => ((e, t) => {
        ...
        ls = (e, t) => {
            ...
            for (let t = e[o]; t; t = t[o])
                if (os(mn(t))) return void(null === (n = t.parentNode) || void 0 === n || n.removeChild(t))
        },
        ds = (e, t, n) => {
        ...
        Cs = (e, t = {}) => {
            ...
            return {
                load: i,
                loadAll: e => Promise.allSettled($(e, (e => i(e).then(N(e))))).then((e => {
        ...
        Ys = e => Gs("td th li dt dd figcaption caption details summary", e.getTextBlockElements()),
        Xs = (e, t) => {
            if (e) {
                const n = {};
                return m(e) && (e = {
        ...
        bind(e, t, n, o) {
            ...
            for (; c--;) {
                let t = d[c],
                    ...
                    m = !1,
                    f = !1;
                "DOMContentLoaded" === t && (t = "ready"), r.domLoaded && "ready" === t && "complete" === e.readyState ? n.call(o, sa({
                    type: t
                ...
                }), s = r.events[l][t], s ? "ready" === t && r.domLoaded ? n(sa({
                    type: t
                })) : s.push({
                    func: n,
                    scope: o
    ...
    const Ca = e => {
        ...
        Sa = {
            ...
            isRtl: () => ka().bind((e => we(e, "_dir"))).exists((e => "rtl" === e)),
            hasCode: e => xe(wa, e)
        },
        _a = () => {
            const e = [],
    ...
    const Ea = e => {
        ...
        Fa = (e, t) => Gt(e, "data-mce-bogus") || No(e, '[data-mce-bogus="all"]', Ma(t)),
        Ua = (e, t) => {
    ...
    const Ha = e => {
        ...
        Za = (e, t) => e.top > t.bottom || !(e.bottom < t.top) && Qa(t.bottom - e.top, e, t),
        ei = (e, t, n) => {
    ...
    const ki = (e, t) => {
        ...
        Oi = e => t => e === t,
        Ti = e => (_i(e) ? "text()" : e.nodeName.toLowerCase()) + "[" + (e => {
            let t, n;
        ...
        Bi = (e, t) => {
            ...
            if (_i(r)) n = ((e, t) => {
                let n = e;
                for (;
                    (n = n.previousSibling) && _i(n);) t += n.data.length;
                return t
            })(r, s);
            else {
        ...
        Hi = (e, t) => {
            ...
            return Si(n, o, c), e.moveToBookmark({
                id: r,
                keep: !0,
                forward: l
            }), {
    ...
    const Gi = e => "inline-command" === e.type || "inline-format" === e.type,
        ...
        bc = (e, t, n, o, r) => {
            ...
            if (pc(t)) {
                ...
                for (; i = hc(s.prev.bind(s), r);)
                    if (n(i)) return i
            }
            if (gc(t)) {
                if (a && (i = hc(s.next.bind(s), !0), n(i))) return i;
                for (; i = hc(s.next.bind(s), r);)
                    if (n(i)) return i
            }
            return null
        },
    ...
    const Dc = Yo,
        ...
        Uc = Gr,
        zc = (e, t) => e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null,
        jc = (e, t) => {
            if (gc(e)) {
        ...
        Yc = (e, t, n, o) => Gc(e, t, n).bind((n => o(n) ? Yc(e, t, n, o) : M.some(n))),
        Xc = (e, t) => {
        ...
        gu = (e, t) => {
            ((e, t) => {
                ...
                if (t) {
                    if (su(t)) return ((e, t) => {
                        const n = e.createRng();
                        return cu(e, !0, t, n) && cu(e, !1, t, n) ? M.some({
                            range: n,
                            forward: au(t)
                        }) : M.none()
                    })(n, t);
    ...
    const bu = e => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        gm = (e, t, n, o) => {
            ...
            if (s && em(i) && i.wrapper && (s = sm(e, s, "ul,ol").reverse()[0] || s), !s)
                for (s = n; s && s[o] && !e.isBlock(s[o]) && (s = s[o], !Gu(s, "br")););
            return s || n
        },
        pm = (e, t, n, o) => {
    ...
    const bf = e => "textarea" === Lt(e),
        ...
        wf = (e, t, n, o) => {
            ...
            const a = ((e, t) => {
                const n = ((e, t) => {
                        const n = An(e);
                        if (0 === n.length || bf(e)) return {
                            element: e,
                            offset: t
                        };
                        if (t < n.length && !bf(n[t])) return {
                            element: n[t],
                            offset: 0
                        }; {
        ...
        zf = e => Gm.range(mn(e.startContainer), e.startOffset, mn(e.endContainer), e.endOffset),
        jf = e => {
    ...
    const Kf = ba.DOM,
        ...
        Yf = (e, t) => {
            ...
            (e => {
                ...
                n && zn(t).each((t => {
                    const o = t;
                    o.ownerDocument === document && (o === document.body || Gf(n, o) || e.focusedEditor !== n || (n.dispatch("blur", {
                        focusedEditor: null
                    }), e.focusedEditor = null))
                }))
        ...
        Zf = e => e.inline ? (e => {
            ...
            var n, o
        })(e) : (e => C(e.iframeElement) && Pf(mn(e.iframeElement)))(e),
    ...
    const Ng = ["font", "text-decoration", "text-emphasis"],
        ...
        Pg = (e, t) => n => Cc(e ? 0 : -1, n).filter(t).isSome(),
        Lg = e => Ko(e) && "block" === Wn(mn(e), "display"),
        Mg = e => Yo(e) && !(e => To(e) && "all" === e.getAttribute("data-mce-bogus"))(e),
        Ig = Pg(!0, Lg),
        Fg = Pg(!1, Lg),
        Ug = Pg(!0, Jo),
        zg = Pg(!1, Jo),
        ...
        rp = (e, t) => (e => M.from(e.getNode(!0)).map(mn))(t).exists(ur) || np(!1, e, t).isSome(),
        sp = O(np, !1),
        ap = O(np, !0),
        ...
        })(t, e) ? xi(t.container(), t.offset() - 1) : t,
        Ep = e => {
        ...
        zp = e => Up(e, "Delete"),
        jp = e => mr(e) || gr(e),
        Hp = (e, t) => vn(e, t) ? ko(t, jp, (e => t => Bt(xn(t), e, bn))(e)) : M.none(),
        $p = (e, t = !0) => {
        ...
        oh = (e, t) => {
            ...
            return ((e, t, n) => e.exists((e => ((e, t) => !Xp(e) && Qp(e, t).exists((e => {
                ...
                return M.none()
            })))(o, r, t, n) : ((e, t, n, o) => Zp(e, t, n, o).bind((({
                start: e,
                end: t
            }) => e.or(t))).bind((e => {
                const {
                ...
                if (r.length > 0) {
                    if (o) return M.some(Gp.partialTable(r, M.none())); {
                        const e = nh(n, t);
                        return M.some(Gp.partialTable(r, M.some({
                            ...t,
                            rng: e
                        })))
                    }
            ...
            return ((e, t) => {
                ...
                if (t) {
                    ...
                    Tt.each(o.select("*[data-mce-fragment]"), (e => {
                        if (C(n[e.nodeName.toLowerCase()]) && ((e, t) => te(Rg(e, t), (e => !(e => Eg.has(e))(e))))(o, e))
                            for (let n = e.parentElement; C(n) && n !== t && !Ag(o, e, n); n = n.parentElement)
                                if (r.compare(n, e)) {
                                    o.remove(e, !0);
                                    break
                                }
                ...
                f = (o, a, i) => {
                    ...
                    ym(o, a, (a => {
                        ...
                        const p = a => {
                            ...
                            if ((o => (e => em(e) && !0 === e.wrapper)(s) && Yh(e, o, t, n))(a)) u = null;
                            else {
                                if (((t, n, o) => {
                ...
                if (o)
                    ...
                    V((e => K((e => {
                        ...
                        if (1 === t.length) return ub(n, t[0]) && mb(n, t[0]) ? t : []; {
                            const e = ie(t).filter((e => ub(n, e))).toArray(),
                                o = le(t).filter((e => mb(n, e))).toArray(),
                                r = t.slice(1, -1);
    ...
    var mv, fv = kv(Array.prototype.forEach),
    ...
    var Nv = av(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
        ...
        Gv = function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Wv(),
                n = function(t) {
                    return e(t)
                };
            ...
            var Ae = function(e) {
                ...
                Ie = function(e) {
                    ...
                    return e instanceof l && !Ae(e) ? (Oe(e), !0) : "noscript" !== o && "noembed" !== o || !wv(/<\/no(script|embed)/i, e.innerHTML) ? (X && 3 === e.nodeType && (t = e.textContent, t = vv(t, D, " "), t = vv(t, P, " "), e.textContent !== t && (pv(n.removed, {
                        element: e.cloneNode()
                ...
                Fe = function(e, t, n) {
                    ...
                    else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== yv(n, "data:") || !de[e])
                        if (Y && !wv(I, vv(n, F, "")));
                        else if (n) return !1;
                    return !0
                },
    ...
    const my = Tt.makeMap,
        ...
        py = Tt.makeMap("src,href,data,background,action,formaction,poster,xlink:href"),
        hy = "data-mce-type",
        by = (e, t) => {
            const n = Gv(),
                    ...
                    parse: (e, n = {}) => {
                        ...
                        const [f, p] = ((e, t, n, o) => {
                            const r = n.validate,
                                ...
                                i = fy(my("script,style,head,html,body,title,meta,param"), t.getBlockElements()),
                                l = Ys(t),
                                d = /[ \t\r\n]+/g,
                                c = /^[ \t\r\n]+/,
                                u = /[ \t\r\n]+$/,
        ...
        wy = (e, t) => {
            if (t.no_events) return Wi.value(t); {
                ...
                return n.isDefaultPrevented() ? Wi.error(Tm(e, {
                    content: "",
                    ...n
                }).content) : Wi.value(n)
            }
        },
        xy = (e, t, n) => n.no_events ? t : Cy(t, (t => Tm(e, {
            ...n,
            content: t
        }))).content,
        ky = (e, t) => {
            if (t.no_events) return Wi.value(t); {
                const n = Cy(t.content, (n => ((e, t) => e.dispatch("BeforeSetContent", t))(e, {
                    ...t,
                    content: n
                })));
        ...
        Ly = () => Jm([]),
        My = (e, t) => ((e, t) => So(t, "table", O(bn, e)))(e, t[0]).bind((e => {
            const n = t[0],
                o = t[t.length - 1],
                r = (e => {
                    const t = _y(Va(e), 0, []);
        ...
        Qy = e => ({
            ...
            undoManager: {
                ...
                undo: (t, n, o) => ((e, t, n, o) => {
                    let r;
                    return t.typing && (t.add(), t.typing = !1, Yy(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), r = t.data[o.get()], Vy(e, r, !0), e.setDirty(!0), e.dispatch("Undo", {
                        level: r
                    })), r
                })(e, t, n, o),
                redo: (t, n) => ((e, t, n) => {
                    let o;
                    return t.get() < n.length - 1 && (t.set(t.get() + 1), o = n[t.get()], Vy(e, o, !1), e.setDirty(!0), e.dispatch("Redo", {
                        level: o
                    })), o
                })(e, t, n),
                clear: (t, n) => ((e, t, n) => {
                        ...
                        const n = ((e, t) => {
                            if ("text" === t.format) return (e => M.from(e.selection.getRng()).map((t => {
                                ...
                                const i = e.dom.add(r, s, {
                                    ...
                                    l = Uy(i),
                                    d = _r(null !== (n = i.textContent) && void 0 !== n ? n : "");
                                ...
                                const n = ((e, t) => {
                                    const n = e.selection.getRng(),
                                        ...
                                        s = sg(e, Eu(r)),
                                        a = t.contextual ? Iy(mn(e.getBody()), s).dom : n.cloneContents();
            ...
            autocompleter: {
                ...
                removeDecoration: () => ((e, t) => cg(t).each((t => {
                    const n = e.selection.getBookmark();
    ...
    const UC = (e, t) => {
        ...
        iw = (e, t) => {
            const n = mn(e),
                o = mn(t.container());
            return Hp(n, o).map((e => ((e, t) => ({
                block: e,
                position: t
            }))(e, t)))
        },
        lw = (e, t) => ko(t, (e => hr(e) || Go(e.dom)), (t => bn(t, e))).filter(Ft).getOr(e),
        dw = e => {
            const t = (e => {
                const t = An(e);
        ...
        Lw = (e, t) => e.selection.isCollapsed() ? ((e, t) => {
            const n = xi.fromRangeStart(e.selection.getRng());
        ...
        jw = O(zw, !0),
        Hw = O(zw, !1),
        $w = (e, t) => zo(e.container()) ? zw(t, e.container()) : zw(t, e.getNode()),
        Vw = (e, t) => {
            const n = t.get();
        ...
        ix = (e, t, n, o, r, s) => Dt(Lp(t, n, o), Lp(t, n, r), ((t, o) => t !== o && ((e, t, n) => {
            const o = vc(t, e),
                r = vc(n, e);
            return C(o) && o === r
        })(n, t, o) ? Kw.after(e ? t : o) : s)).getOr(s),
        lx = (e, t) => e.fold(L, (e => {
    ...
    const Bx = (e, t, n, o, r, s) => {
        ...
        $x = (e, t, n) => Hx(e, t).filter(n).exists((t => (e.selection.setRng(t.toRange()), !0))),
        Vx = (e, t) => {
        ...
        Xx = e => {
            ...
            return e.on("NodeChange", (o => {
                Xl(e) && (((e, t, n) => {
                    const o = $(or(mn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'), (e => e.dom)),
                        r = K(o, e),
                        s = K(n, e);
        ...
        ik = (e, t) => e.selection.isCollapsed() ? ((e, t) => {
            const n = t ? Ug : zg,
        ...
        fk = (e, t) => {
            ...
            const {
                dom: r
            } = e, s = Ll(e), a = null !== (o = null === (n = /[a-z%]+$/i.exec(s)) || void 0 === n ? void 0 : n[0]) && void 0 !== o ? o : "px", i = lk(s), l = Pl(e);
            V(mk(e), (e => {
                ((e, t, n, o, r, s) => {
                    const a = dk(n, mn(s)),
                        i = lk(e.getStyle(s, a));
        ...
        Ck = (e, t) => !!zo(t) || !!To(t) && !yk(e.getBlockElements(), t) && !pu(t) && !ps(e, t),
        wk = (e, t) => {
            if (zo(t)) {
        ...
        jk = (e, t) => Q(((e, t) => ee((e => $(e, (e => ({
            ...Fk,
            ...e
        }))))(e), (e => Uk(e, t) ? [e] : [])))(e, t), (e => e.action())),
        Hk = (e, t) => ce(((e, t) => ee((e => $(e, (e => ({
            ...Fk,
            ...e
        }))))(e), (e => Uk(e, t) ? [e] : [])))(e, t), (e => e.action())),
        $k = (e, t) => {
        ...
        Gk = (e, t, n) => ee(An(e), (e => pn(e, t) ? n(e) ? [e] : [] : Gk(e, t, n))),
        Yk = (e, t) => Eo(e, "table", t),
        Xk = (e, t, n, o, r = L) => {
            const s = 1 === o;
        ...
        tS = O(eS, (e => e.bottom), ((e, t) => e.y < t)),
        nS = O(eS, (e => e.top), ((e, t) => e.y > t)),
        oS = (e, t, n) => {
            const o = e(t, n);
        ...
        cS = (e, t) => dS(e, t, aS),
        uS = (e, t) => dS(e, t, lS),
        mS = (e, t, n) => n.fold(M.none, M.none, ((e, t) => {
            return (n = t, ((e, t) => {
                const n = e => {
    ...
    const TS = (e, t, n) => e.stype === OS.Error ? t(e.serror) : n(e.svalue),
        ...
        WS = (e, t, n, o, r) => {
            const s = e => r.extract(t.concat([o]), e),
                a = e => e.fold((() => BS(M.none())), (e => {
                    const n = r.extract(t.concat([o]), e);
                    return s = n, a = M.some, s.stype === OS.Value ? {
                        stype: OS.Value,
                        svalue: a(s.svalue)
                    } : s;
                    var s, a
    ...
    const I_ = e => {
            const t = e.ui.registry.getAll().popups,
                n = ge(t, (e => {
                    return (t = e, YS("Autocompleter", N_, {
                        trigger: t.ch,
                        ...t
                    })).fold((e => {
        ...
        V_ = e => M.from(e.dom.getParent(e.selection.getStart(!0), e.dom.isBlock)),
        q_ = (e, t) => {
            ...
            insert: (e, t) => {
                ...
                const i = e.dom,
                    ...
                    f = t => {
                        ...
                        let d = a;
                        if (!1 === yl(e)) i.setAttrib(a, "style", null), i.setAttrib(a, "class", null);
                        else
                            do {
                                if (s[o.nodeName]) {
                ...
                if ("LI" !== x || b || (w = s, s = s.parentNode, r = x), /^(LI|DT|DD)$/.test(r) && To(s) && i.isEmpty(w)) return void((e, t, n, o, r) => {
                    ...
                    else if (G_(n, o, !0)) q_(n, "LI") ? (s.insertAfter(d, K_(n)), d.appendChild(s.doc.createTextNode(" ")), d.appendChild(n)) : i.insertBefore(d, n), s.remove(o);
                ...
                else if (g(!0) && k) S = k.insertBefore(f(), w), H_(e, Q_(w, "HR") ? S : w);
                else {
                    const t = (e => {
                        const t = e.cloneRange();
                ...
                i.setAttrib(S, "id", ""), e.dispatch("NewBlock", {
                    newBlock: S
                })
            },
            ...
            insert: (e, t) => {
                ...
                n.isSome() ? n.each(O(lE, e)) : ((e, t) => {
                    ...
                    "LI" !== u || m || (d = c), zo(l) && i >= l.data.length && (((e, t, n) => {
                        ...
                        for (; r = o.next();)
                            if (s[r.nodeName.toLowerCase()] || zo(r) && r.length > 0) return !0;
                        return !1
        ...
        fE = e => (t, n) => (e => V_(e).filter((e => gr(mn(e)))).isSome())(t) === e,
        gE = (e, t) => (n, o) => {
        ...
        wE = (e, t) => (n, o) => Y(e, ((e, t) => e && t(n, o)), !0) ? M.some(t) : M.none(),
        xE = (e, t, n) => {
                    ...
                    e.on("keydown", (t => {
                        t.isDefaultPrevented() || ((e, t) => {
                            Hk([{
                                ...
                                t.preventDefault(), j_(e, "insertText", {
                                    data: " "
                                }).isDefaultPrevented() || (n(), z_(e, "insertText", {
                                    data: " "
                                }))
                            }))
                        })(e, t)
    ...
    class LE {
        constructor(e) {
            ...
            "onselectionchange" in e.getDoc() || e.on("NodeChange click mouseup keyup focus", (n => {
                ...
                t && Pu(e) && !n.isSameElementPath(t) && e.dom.isChildOf(t, e.getBody()) && e.nodeChanged({
                    selectionChange: !0
                })
            })), e.on("mouseup", (t => {
    ...
    const ME = N("x-tinymce/html"),
        ...
        dN = e => ({
            html: FE(e.selection.getContent({
                contextual: !0
            })),
    ...
    const _N = (e, t) => Math.abs(e.left - t),
                ...
                if (e.dragging) {
                    const s = r.currentTarget === t.getDoc().documentElement,
                        l = ((e, t) => ({
                            ...
                            return n = (e => e.inline ? TN(e.getBody()) : {
                                left: 0,
                                top: 0
                            })(e), o = (e => {
                                const t = e.getBody();
                        ...
                        if (l(o)) return (o => {
                            ...
                            const d = ((o, r) => {
                                    const a = mn(e.getBody()),
                                        ...
                                        d = n.createRng();
                                    no(l), to(l, [un(tr, i), mn(r), un(tr, i)]), d.setStart(l.dom.firstChild, 1), d.setEnd(l.dom.lastChild, 0), qn(l, {
        ...
        NR = (e, t) => {
            if (e.inline || (e.getElement().style.visibility = e.orgVisibility), t || e.inline) ER(e);
            else {
                const t = e.iframeElement,
                    o = (n = mn(t), lo(n, "load", LC, (() => {
        ...
        MR = (e, t) => {
            ...
            ((e, t) => {
                ...
                const o = LR(t, "default", n),
                    r = (e => M.from(_l(e)).filter(We).map((e => ({
                        url: e,
                        name: M.none()
                    }))))(t).orThunk((() => LR(t, Sl(t), "")));
                V((e => {
        ...
        JR = QR("font-size"),
        ZR = _((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), QR("font-family")),
        ...
        })))(e).orThunk(O(eA, e)).map(mn).filter(Ft).bind(t))(e, E(M.some, t)),
        nA = (e, t) => {
            if (/^[0-9.]+$/.test(t)) {
    ...
    class jA {
        constructor(e, t, n) {
            ...
            const d = cd(o);
            C(d) && ba.DOM.styleSheetLoader._setContentCssCors(d), _a.languageLoad = s("language_load"), _a.baseURL = n.baseURL, this.setDirty(!1), this.documentBaseURI = new uy(dl(o), {
                base_uri: this.baseUri
            }), this.baseURI = this.baseUri, this.inline = nd(o), this.hasVisual = gd(o), this.shortcuts = new MA(this), this.editorCommands = new iA(this), rA(this);
        ...
        save(e = {}) {
            ...
            if (s.no_events || t.dispatch("SaveContent", s), "raw" === s.format && t.dispatch("RawSaveContent", s), r = s.content, Uo(n)) n.value = r;
            else {
        ...
        resetContent(e) {
            void 0 === e ? cC(this, this.startContent, {
                format: "raw"
            }) : cC(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
        }
        isDirty() {
        ...
        remove() {
            (e => {
                if (!e.removed) {
                    ...
                    o && e.save({
                        is_removing: !0
                    }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && C(null == r ? void 0 : r.nextSibling) && pC.remove(r.nextSibling), (e => {
                        e.dispatch("remove")
    ...
    const KA = e => {
        ...
        QA = {
            ...
            add(e) {
                const t = this,
                    n = t.get(e.id);
                return n === e || (null === n && WA.push(e), GA(!0), t.activeEditor = e, t.dispatch("AddEditor", {
                    editor: e
                }), VA || (VA = e => {
            ...
            remove(e) {
                ...
                let n;
                if (e) {
                    if (!m(e)) return n = e, h(t.get(n.id)) ? null : (YA(n) && t.dispatch("RemoveEditor", {
                        editor: n
                    }), 0 === WA.length && window.removeEventListener("beforeunload", VA), n.remove(), GA(WA.length > 0), n);
                    $A(HA.select(e), (e => {
                        n = t.get(e.id), n && t.remove(n)
                    }))
                } else
                    for (let e = WA.length - 1; e >= 0; e--) t.remove(WA[e])
            },
            execCommand(e, t, n) {
                var o;
                const r = this,
            ...
            util: {
                ...
                ImageUploader: e => {
                    const t = IC(),
                        n = jC(e, t);
                    return {
                        upload: (t, o = !0) => n.upload(t, o ? zC(e) : void 0)
                    }
                }
            },
            dom: {
...
tinymce.baseURL = "https://cdn.tiny.cloud/1/no-origin/tinymce/6.3.1-12"
    ...
    ! function() {
        ...
        t = null != (t = tinymce.defaultOptions) ? t : tinymce.defaultSettings, c = {
            load: s
        }, a = function(t) {
            t = t.api_key;
            return i(t) ? t : void 0
