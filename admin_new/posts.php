          ...
          <div class="col-md-12">
            <div class="d-flex"><h3 class="text-dark">Posts</h3> <a href="post_new.php" class="btn btn-info btn-sm mb-5 btn-round ml-2"><i class="feather icon-plus"></i>Add New</a></div> 
             <div class="card mt-2">
               <div class="card-body">
                     <div class="">
                         <table id="data_table2" class="table table-striped table-striped mb-0">
                             <thead>
                                 <tr class="text-info"> 
                            ...
                            <?php 
                                $i=1;
                                $data = SelectData('blog_news',"INNER JOIN blogs_category ON blog_news.cat_title=blogs_category.cat_id ORDER BY datetime DESC");
                                foreach($data as $row){?>
