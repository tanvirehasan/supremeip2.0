            ...
            <div class="col-12">
                <div class="">
                    ...
                    <div class="container my-5">
                        ...
                        <input type="text" class="form-control mb-4 " name="facebook" value="<?= $team->facebook ?>">

                        <label for="categoryname" class=" form-label" style="font-weight:700;">Linkedin*</label>
                        <input type="text" class="form-control mb-4 " name="linkedin" value="<?= $team->linkedin ?>">

                        <label for="categoryname" class=" form-label" style="font-weight:700;">Whatsapp*</label>
                        <input type="text" class="form-control mb-4 " name="whatsapp" value="<?= $team->whatsapp ?>">
