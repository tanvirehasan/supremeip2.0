        ...
        <!-- default_img -->
            <div class="card p-3 bg" >
                <form method="POST" action="" enctype="multipart/form-data">
                   ...
                   <div class="col-md-12">  
                        <label class=" form-label " style="font-weight:700;">Left Sidebar</label> 
                        <p style='height:60px;width:100%; border:none; background:<?=$row->Left_Sidebar_bg?>'></p>
                        <select name="Left_Sidebar_bg" id="" class="form-control">
                            <option value="<?=$row->Left_Sidebar_bg?>" ><?=color_name($row->Left_Sidebar_bg)?></option>
                        <?php 
                    ...
                    <div class="col-md-12">  
                        ...
                        <p style='height:60px;width:100%; border:none; background:<?=$row->Center_bg?>'></p>
                        <select name="Center_bg" id="" class="form-control">
                            <option value="<?=$row->Center_bg?>" ><?=color_name($row->Center_bg)?></option>
                        <?php 
                                $data = SelectData('color_settings','');
                                while ($textcolor = $data->fetch_object()) {?>
                                <option value="<?=$textcolor->color_code?>" ><?=$textcolor->color_name?></option>
                    ...
                    <div class="col-md-12">  
                        <label class=" form-label " style="font-weight:700;">Right Sidebar</label> 
                        <p style='height:60px;width:100%; border:none; background:<?=$row->right_sidebar_bg?>'></p>
                        <select name="right_sidebar_bg" id="" class="form-control">
                            <option value="<?=$row->right_sidebar_bg?>" ><?=color_name($row->right_sidebar_bg)?></option>
                        <?php 
                                $data = SelectData('color_settings','');
                                while ($textcolor = $data->fetch_object()) {?>
                                <option value="<?=$textcolor->color_code?>" ><?=$textcolor->color_name?></option>
...
<!--------- Section -2 ---------->    
        ...
        <div class="col-md-4 setting">
            ...
            <div class="card p-3">
                ...
                <div class="card p-3">
                    <form method="POST" action="" enctype="multipart/form-data">
                        <label for="categoryname" class="h5 w-100" style="font-weight:700;">Button Settings</label>
                             <input type="text" class="form-control mb-3" value="<?=btn_settings('padding');?>" name="padding" placeholder="padding">
                            <table class="mb-3" style="width: 100%;">
                            
                                <tr>
                                    <td>font size:</td>
                                    <td><input type="text" name="font_size" class="form-control" min="1" max="100" value="<?=btn_settings('font_size');?>" id="font_size_submenu"></td>

                                    <td  style="font-family:<?=btn_settings('font_fmaily');?>;">Font:</td>
                                    <td>
                                        <select name="font_fmaily" class="form-control">
                                            <option value="<?=btn_settings('font_fmaily');?>"><?=btn_settings('font_fmaily');?></option>
                                            <?=font_select()?>
                                        </select>
                                    </td>
                                    <td> | </td>
                                    <td  style="text-transform:<?=btn_settings('Letter_case');?>;">Letter case:</td>
                                    <td>
                                        <select name="Letter_case" class="form-control" >
                                            <option value="<?=btn_settings('Letter_case');?>">Select</option>
                                            <option value="uppercase">uppercase</option>
                                            <option value="lowercase">lowercase</option>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td>Text Color:
                                        <input type="color" value="<?=btn_settings('text_color');?>" class="form-control" style='height: 50px; border:none; padding:0'>
                                        <select name="text_color" class="form-control">
                                            <option value="<?=btn_settings('text_color');?>" ><?=color_name(btn_settings('text_color'))?></option>
                                            <?php select_color(); ?>
                                        </select>
                                    </td>

                                    <td>BG Color:
                                        <input type="color"  value="<?=btn_settings('btn_bg');?>" class="form-control" style='height: 50px; border:none; padding:0'>

                                        <select name="btn_bg" class="form-control">
                                            <option value="<?=btn_settings('btn_bg');?>" ><?=color_name(btn_settings('btn_bg'))?></option>
                                            <?php select_color(); ?>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <div class=" m-0 my-3"><button type="submit" name="btnstyle_update" class="btn btn-primary">Update</button></div> 
                    </form> 
                </div>
