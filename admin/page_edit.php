		  ...
		  <div class="px-4 py-3">
            ...
            <div class="Visibility mt-5">
			 ...
			 <div class="Widget mt-5">
                ...
                <a class="btn btn-dark text-white m-1" onclick="widget('views/widget/widget_insert.php?readmore=<?=$row->page_id?>&title=Read More')">+ Read More</a>	 	
                <a class="btn btn-dark text-white m-1" onclick="widget('views/widget/widget_insert.php?clientsadd=<?=$row->page_id?>&title=Client')">+ client</a>	 	
                <a class="btn btn-dark text-white m-1" onclick="widget('views/widget/widget_insert.php?teamadd=<?=$row->page_id?>&title=Team')">+ Team</a>	 	
                <a class="btn btn-dark text-white m-1" onclick="widget('views/widget/widget_insert.php?images=<?=$row->page_id?>&title=Images')">+ Images</a>	 	
			 </div>
