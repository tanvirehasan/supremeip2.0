		...
		<div class="col-12 col-md-2 my-5 bg-white">
		  <div class="px-4 py-5">
			...
			<div class="drop-zone">
			 ...
			 <h5 class="mt-3 p-0 m-0"><i class="fas fa-file-alt"></i> Date Time</h5>
			 <input type='datetime-local' name='postdatetime' class='form-control' id="birthdaytime" value="<?=$row->datetime?>" >
